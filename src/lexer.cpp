...
Token Lexer::scanToken()
{
    ...
    switch (get())
    {
        ...
        case '@':
            ...
            {
                get();
                return Token(TokenType::AtAt, "@@", line, column);
            }
            break;
        case '(':
